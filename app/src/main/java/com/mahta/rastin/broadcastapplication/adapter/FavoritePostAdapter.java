...
public class FavoritePostAdapter extends RealmRecyclerViewAdapter<FavoritePost,FavoritePostAdapter.CustomViewHolder>{

    private LayoutInflater inflater;
    private OnItemClickListener onItemClickListener;

    public FavoritePostAdapter(Context context, RealmResults<FavoritePost> realmResults) {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        final FavoritePost current = realmResults.get(position); //This is nice
