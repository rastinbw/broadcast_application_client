...
import com.mahta.rastin.broadcastapplication.adapter.ProgramAdapter;
...
import com.mahta.rastin.broadcastapplication.dialog.GroupListDialog;
...
public class ProgramListFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final RecyclerView rcvPrograms = view.findViewById(R.id.rcvPrograms);
        setupToolbar(view);

        view.findViewById(R.id.lnlGroup).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                GroupListDialog dialog = new GroupListDialog(getActivity());
        ...
        btnShowFavoriteProgram = view.findViewById(R.id.btnShowFavoriteProgram);
        view.findViewById(R.id.btnShowFavoriteProgram).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getFragmentManager().beginTransaction()
                        .replace(R.id.frmMainContainer,new FavoriteProgramListFragment())
                        .commit();
            }
        });
        ...
        txtGroups = view.findViewById(R.id.txtGroup);
        txtNoPrograms = view.findViewById(R.id.txtNoProgram);
